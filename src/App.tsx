...
import dien1 from './assets/dien1.jpg'
import dien2 from './assets/dien2.jpg'
      ...
      {!isOpened ? (
        <div className="splash-screen">
          <div className="envelope">
            <h2>🎓 Lễ Tốt Nghiệp Diện Legend😎😎</h2>
            <div className="card-header">
                <img src={dien1} alt="Dien" className="avatar" />
        ...
        <>
          <div className="card fade-in">
            <h1>Thư Mời Tốt Nghiệp</h1> <br />

            <div className="message">
              <p>
                Thế giới sắp có thêm một câu chuyện đáng kể.  
                Và mình đã sẵn sàng viết tiếp nó 😎

                Mời bạn đến dự lễ tốt nghiệp của mình,  
                để cùng chia sẻ khoảnh khắc mình bước sang một chặng đường mới.
              </p>
            </div>
            <div className="extra-info">
              <p><strong>Người mời:</strong> Diện Xinhh Đẹpp ❤️❤️👌</p>
              <p><strong>Liên hệ:</strong> 0353711902</p> <br />
          </div>
            ...
            <section className="signature-section">
              <p style={{ marginTop: "20px", fontStyle: "italic" }}>
                Rất mong được gặp bạn trong ngày đặc biệt này ❤️ <br />
                Nhớ để lại lời chúc và chữ ký của bạn nhá! 💌 <br />
                Loveeee Yuuuuuu 🙆‍♀️🙆‍♀️🙆‍♀️🙆‍♀️🙆‍♀️ <br />
              </p>
